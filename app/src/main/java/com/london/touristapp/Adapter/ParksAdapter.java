...
public class ParksAdapter extends RecyclerView.Adapter<ParksAdapter.ViewHolder> {
    ...
    private ArrayList<ModelPark> mData;
    private LayoutInflater mInflater;

    private  Context mContext;

    // data is passed into the constructor
    public ParksAdapter(Context context, ArrayList<ModelPark> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.lyt_park ,parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position)
    {
        ...
        final ModelPark data = mData.get(position);
