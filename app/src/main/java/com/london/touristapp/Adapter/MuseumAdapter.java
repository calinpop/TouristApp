...
public class MuseumAdapter extends RecyclerView.Adapter<MuseumAdapter.ViewHolder> {
    ...
    private ArrayList<ModelMuseum> mData;
    private LayoutInflater mInflater;

    private  Context mContext;

    // data is passed into the constructor
    public MuseumAdapter(Context context, ArrayList<ModelMuseum> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.lyt_museum ,parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position)
    {
        ...
        final ModelMuseum data = mData.get(position);
